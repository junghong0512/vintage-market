...
const Upload: NextPage = () => {
  return (
    <div className='px-4 py-16'>
      <div>
        <label className='w-full text-gray-600 hover:text-orange-500 hover:border-orange-500 flex items-center justify-center border-2 border-dashed border-gray-300 py-6 h-48 rounded-md cursor-pointer'>
          <svg
            className='h-12 w-12'
            stroke='currentColor'
            fill='none'
