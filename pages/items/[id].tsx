      ...
      <div className='mb-6'>
        ...
        <div className='mt-5'>
          ...
          <div className='flex items-center justify-between space-x-2'>
            <button className='flex-1 bg-orange-500 text-white py-3 font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 hover:bg-orange-600 transition-colors'>
              Talk to seller
            </button>
